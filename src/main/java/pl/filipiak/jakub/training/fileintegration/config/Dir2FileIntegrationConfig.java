...
public class Dir2FileIntegrationConfig {
    ...
    public Dir2FileIntegrationConfig(Dir2ConfigProperties properties,
    ...
    @Bean
    @InboundChannelAdapter(value = "directory2Channel", poller = @Poller(fixedDelay = pollingIntervalInMillis))
    public MessageSource<File> directory2FileReadingMessageSource() {
        return configProvider.createFileReadingMessageSource(
                filterProvider.createDefaultCompositeFileListFilter(directory2MetadataStore()));
    }
